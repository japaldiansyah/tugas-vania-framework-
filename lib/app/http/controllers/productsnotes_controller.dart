...
import 'package:store/app/models/productsnotes.dart';
// ignore: implementation_imports
import 'package:vania/src/exception/validation_exception.dart';

class ProductsnotesController extends Controller {
  ...
  Future<Response> store(Request request) async {
    try {
      ...
      final existingProductNotes = await Productsnotes()
          .query()
      ...
      await Productsnotes().query().insert(productnotesData);
  ...
  Future<Response> update(Request request, int noteId) async {
    try {
      ...
      final existingProductNotes =
          await Productsnotes().query().where('note_id', '=', noteId).first();
  ...
  Future<Response> destroy(int id) async {
    try {
      ...
      final existingProductNotes =
          await Productsnotes().query().where('note_id', '=', id).first();
      ...
      await Productsnotes().query().where('note_id', '=', id).delete();
...
final ProductsnotesController productnotesController = ProductsnotesController();